...
class TestWebcamData(Dataset):
    def __init__(self, webcam_images, iscrop=True, crop_size=224, scale=1.25, face_detector='fan',
                 scaling_factor=1.0, max_detection=None):
        self.max_detection = max_detection
        #print('total {} images'.format(len(self.imagepath_list)))
        self.image_list = webcam_images
        ...
        if face_detector == 'fan':
            ...
            self.face_detector = MediaPipeLandmarkDetector()
